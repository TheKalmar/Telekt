...
def test_v2_workflow_id_does_not_replay_legacy_polling_history():
    assert temporal_gateway.workflow_id("abc") == "company-loop-v2-abc"
    assert TASK_QUEUE == "digital-company-v2"
