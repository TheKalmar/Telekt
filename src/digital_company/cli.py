...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Digital AI Company POC")
    ...
    if args.command == "init":
        ...
        print(json.dumps({"status": "initialized", "goal": args.goal, "budget": args.budget}, indent=2))
        ...
        try:
            ...
            result = {
                ...
                "reason": "OpenAI API credits or quota are exhausted" if exhausted else "OpenAI API rate limit reached",
            ...
            result = {"status": "api_unavailable", "reason": "The key or project cannot access the configured model"}
